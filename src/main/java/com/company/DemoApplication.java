...
import com.company.universe.galaxyMutator.OptimalPlanetDistributor;
...
//        int n = graph.size();
        Graph graph = GraphGenerator.generate(250,
                10,100,
                    10, 50);
        ...
        long diff = galaxy.getWeight() - best.get().getWeight();
